...
describe('Create Company Use Case', () => {
    beforeEach(async () => {
        ...
        sut = new CreateCompanyUseCase(usersRepository, companiesRepository, businessUnitRepository);
    ...
    it('should create default business units for a new company', async () => {
        ...
        expect(businessUnits.map((unit) => unit.type)).toEqual(expect.arrayContaining(['LOJA', 'ACADEMIA', 'CASA_DE_JOGOS']));
    });
