...
export const OPERATOR_PERMISSIONS = [
  ...
  // Store: read data, create customer, create/read invoice, print PDF
  INVENTORY.CATEGORIES_READ,
  INVENTORY.PRODUCTS_READ,
  CUSTOMERS.CREATE,
  CUSTOMERS.READ,
  ...
  // Academy: add/edit student, create enrollment, receive payments
  ACADEMY.STUDENTS_CREATE,
  ACADEMY.STUDENTS_READ,
  ACADEMY.STUDENTS_UPDATE,
  ACADEMY.ENROLLMENTS_CREATE,
  ...
  // Gaming house: add customer, open tournament, open/close session, receive payment
  GAMING.CREATE,
  GAMING.READ,
  GAMING.PAYMENTS_CREATE,
  GAMING.PAYMENTS_READ,
